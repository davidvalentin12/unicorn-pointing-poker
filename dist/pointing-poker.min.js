!function () {
    'use strict';
    angular.module('pointingPoker', ["firebase","ui.router"]);
}(), function () {
    'use strict';
    ...
    function o(o, e, t, n, r) {
        ...
        function s() {
            r.roomNumber && o.getRoom(r.roomNumber).then(function (e) {
                g.room = e, o.createUser(r.userName, g.room).then(function (o) {
                    g.user = o, u();
                });
            });
        }
        function a() {
            g.chatVisible = !g.chatVisible, l();
        }
        function c(e) {
            '' != e && (g.room = o.sendMessage(g.room, g.user.$id, e), g.currentMessage = '', g.room.$save());
        }
        function u() {
            e.yOffset = 50, t.$watch(function () {
                return g.room.messages;
            }, function (o, e) {
                l();
            });
        }
        ...
        var g = this;
        g.chatVisible = !1, g.toggleChatVisibility = a, g.sendMessage = c, g.$onInit = i;
    }
    ...
    function o(o, e, t, n, r) {
        ...
        var v = this;
        v.pointingValues = [.5,1,2,3,5,8,13,20,40,100,"?"], v.$onInit = i, v.signOut = s, v.vote = a, v.toggleVotes = u, v.resetVotes = c, v.toggleVoting = l, v.agreement = g, v.explainStory = m;
    }
    ...
    angular.module('pointingPoker').provider('firebasePointingPokerService', function () {
        function o(o, e, t) {
            ...
            function g(n, r) {
                ...
                return m(a, n), a.$loaded().then(function () {
                    i.resolve(a);
                }), i.promise;
            }
            function m(o, e) {
            ...
            var p = this;
            return p.initFirebaseConfig = n, p.getRoom = u, p.removeUser = l, p.createUser = g, p.userVote = c, p.resetVotes = s, p.toggleVoting = a, p.toggleVotesShown = i, p.sendMessage = r, p;
        }
