!function () {
    ...
    function o(o, e, t, n, r) {
        ...
        var m = this;
        m.chatVisible = !1, m.toggleChatVisibility = a, m.sendMessage = u, m.$onInit = i;
    }
    ...
    function o(o, e, t) {
        ...
        function r() {
            o.getRoom(t.roomNumber).then(function (e) {
                c.room = e, o.createUser(t.userName, c.room).then(function (o) {
                    c.user = o, i();
                });
            });
        }
        function i() {
            e.$watch(function () {
                ...
                c.room && c.room.users && (c.voteSumary = s(c.room.users), a(c.room, c.voteSumary));
            }, !0);
        }
        function s(o) {
            var e = {};
        ...
        function a(o, e) {
            var t = u(e);
            Object.keys(e).length > 0 && t ? (o.someoneVoted = !0, 1 == Object.keys(e).length && t ? o.totalAgreement = !0 : o.totalAgreement = !1) : o.someoneVoted = !1, c.room.$save();
        }
        function u(o) {
            var e = !1;
            return angular.forEach(o, function (o) {
    ...
    function o(o, e, t, n, r) {
        ...
        var v = this;
        v.pointingValues = [.5,1,2,3,5,8,13,20,40,100,"?"], v.$onInit = i, v.signOut = s, v.vote = a, v.toggleVotes = c, v.resetVotes = u, v.toggleVoting = l, v.agreement = m, v.explainStory = g;
    }
    ...
    angular.module('pointingPoker').provider('firebasePointingPokerService', function () {
        function o(o, e, t) {
            ...
            var p = this;
            return p.initFirebaseConfig = n, p.getRoom = c, p.removeUser = l, p.createUser = m, p.userVote = u, p.resetVotes = s, p.toggleVoting = a, p.toggleVotesShown = i, p.sendMessage = r, p;
        }
